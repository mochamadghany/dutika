	...
	<div class="subnavbar-inner">
		<div class="container">
			<ul class="mainnav">
				...
				<li class="active"><a href="<?= site_url('c_hint') ?>"><i class="icon-question-sign"></i><span>Hint</span> </a> </li>
					...
					<div class="widget widget-table action-table">
						<div class="widget-header"> 
							...
							<div class="pull-right">
								<a href="<?= site_url('c_hint/tambah') ?>" class="btn btn-small btn-primary">
								...
								<?php 
									...
									foreach ($hint as $h) { ?>
										<tr>
											...
											<td><?= $h->pertanyaan ?></td>
											<td class="td-actions">
												<a href="<?= site_url('c_hint/ubah').'/'.$h->id_hint ?>" class="btn btn-small btn-success">
													<i class="btn-icon-only icon-edit"> </i>
												</a>
												<a href="<?= site_url('c_hint/ubah').'/'.$h->id_hint ?><?= site_url('c_hint/ubah').'/'.$h->id_hint ?>" onclick="javascript: return confirm('Yakin ingin menghapus?')" class="btn btn-danger btn-small">
