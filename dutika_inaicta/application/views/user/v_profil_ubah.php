...
<div class="title-forum"><p class="title-title">Edit Profile</p>
</div>
...
<div class="wrapper-edit-profile">
  <div class="form-header-edit-profile">Edit Profile</i></div>
  ...
  <div class="form-grp-edit-profile">
    <input type="submit" name="ubah" value="Update profile" class="submit-edit-profile"/>
    <?php endforeach;?>
    </form>
  </div>
</div>
...
<div class="hint-warp">
    <div class="columnsContainer-daily">
       ...
       <div class="rightColumn-daily">
        ...
        <img class="<?php echo base_url();?>logic/img-valign-daily" src="<?php echo base_url();?>logic/img/coin.png" alt="" width="25px" height="25px">
          <span class="value-daily">696</span>
          <span class="value-daily-separator"></span>
        <img class="<?php echo base_url();?>logic/img-valign-daily" src="<?php echo base_url();?>logic/img/score.png" alt="" width="25px" height="25px">
          <span class="value-daily">696</span>
