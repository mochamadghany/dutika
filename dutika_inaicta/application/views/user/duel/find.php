...
<input type="checkbox" id="xBxHack" />
        <nav class="mainNav" id="mainNav">
            <div class="container container-nav">
                <p class="progress-title">YOU ARE NOW FINDING OPPONENT</p><a href="<?php echo base_url();?>c_index"><i class="fa fa-times progress-cancel" style="font-size:24px;"></i></a>
            </div>
        </nav>  
...
<div id="waktu"></div>
<center>
    <div class="loading-progress"><p>Please Wait</p></div>
</center>
</body>
<script>
  // on page load...
