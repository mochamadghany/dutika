...
<div class="container-leaderboard">
  ...
  <div class="wrapper-leaderboard">
    <table class="leaderboard-table">
      <thead class="leaderboard-thead">
        <tr class="leaderboard-tr">
          ...
          <th class="leaderboard-th">Name</th>
          <th class="leaderboard-th">Tingkat</th>
          <th class="leaderboard-th">Coin</th>
        </tr>
      </thead>
    ...
    foreach ($coin as $c):?>
        <tr class="leaderboard-tr">
          <td class="urutan leaderboard-td"><?php echo $no;?></td>
          <td class="nama leaderboard-td"><img class="img-valign-rank" src="<?php echo base_url();?>images/user/user/<?php echo $c->foto;?>" alt="" /><?php echo $c->username;?> </td>
          <td class="daerah leaderboard-td"><?php echo $c->tingkat?></td>
          <td class="skor leaderboard-td"><img class="img-valign-rank" src="<?php echo base_url();?>logic/img/coin.png" alt="" /><?php echo $c->coin;?> </td>
        </tr>
      <?php 
      $no++;
      endforeach;?>
...
<h2 style="margin-top:0px;"> Highest Score </h2>
<div class="container-leaderboard">
  ...
  <div class="wrapper-leaderboard">
    <table class="leaderboard-table">
      ...
      <?php
      $no=1;
       foreach ($scorerank as $s):?>
        <tr class="leaderboard-tr">
          <td class="urutan leaderboard-td"><?php echo $no;?></td>
          <td class="nama leaderboard-td"><img class="img-valign-rank" src="<?php echo base_url();?>images/user/user/<?php echo $s->foto;?>" alt="" /><?php echo $s->username?></td>
          <td class="daerah leaderboard-td"><?php echo $s->tingkat?></td>
          <td class="skor leaderboard-td"><img class="img-valign-score" src="<?php echo base_url();?>logic/img/score.png" alt="" /><?php echo $s->scoree?></td>
        </tr>
