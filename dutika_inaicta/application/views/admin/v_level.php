					...
					<div class="widget widget-table action-table">
						<div class="widget-header"> 
							...
							<div class="pull-right">
								<a href="<?php echo base_url(); ?>admin/c_level/tambah" class="btn btn-small btn-primary">
										...
										if ($level=="") {
											...
											foreach ($level as $q) {
												...
												<tr>
													...
													<td>".$q->score."</td>
													<td class='td-actions'>
														<a href='".base_url()."admin/c_level/ubah/".$q->id_level."' class='btn btn-small btn-success'><i class='btn-icon-only icon-edit'> </i></a>
