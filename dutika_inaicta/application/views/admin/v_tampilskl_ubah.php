	...
	<div class="subnavbar-inner">
		<div class="container">
			<ul class="mainnav">
				...
				<li class="active"><a href="<?= site_url('admin/C_tampilskl') ?>"><i class="icon-list-ol"></i><span>Score Coin Level</span> </a> </li>
				...
				<div class="span12">
					...
					<div class="widget widget-table action-table">
						<div class="widget-header"> 
							...
							<div class="pull-left">
								<a href="<?= site_url('admin/c_tampilskl') ?>" class="btn btn-small btn-invert">
						...
						<div class="widget-content" style="overflow-x: auto;">
							<form action="<?php echo base_url();?>admin/C_tampilskl/ubah_simpan" method="POST" style="margin: 30px 140px 80px;">
								<?php foreach ($skl as $q): ?>
									<input type="hidden" name="id_user" value="<?php echo $q->id_user; ?>">
									<input type="hidden" name="id_user_score" value="<?php echo $q->id_user_score; ?>">
									<input type="hidden" name="id_level" value="<?php echo $q->id_level; ?>">
									
									Username : <br> 
									<input type="text" name="username" value="<?php echo $q->username; ?>" readonly><br><br>
									
									Score : <br>
									<input type="text" name="score" value="<?php echo $q->score; ?>"><br><br>
									
									Coin : <br>
									<input type="text" name="coin" value="<?php echo $q->coin; ?>"><br><br>
