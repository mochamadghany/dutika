						...
						<div class="widget-content" style="overflow-x: auto;">
							<table class="table table-striped table-bordered">
								<thead>
									<tr align="center">
										<th>No</th>
										<th>Username</th> <!-- ngambil dari id_user -->
										<th>Score</th>
										<th>Coin</th>
										<th>Level</th>
										...
										if ($skl=="") {
											...
											foreach ($skl as $q) {
												...
												<tr>
													...
													<td>".$q->tingkat."</td>
													<td class='td-actions'>
														<a href='".base_url()."admin/C_tampilskl/ubah/".$q->id_user."' class='btn btn-small btn-success'><i class='btn-icon-only icon-edit'> </i></a>
														<a href='".base_url()."admin/C_tampilskl/hapus/".$q->id_user."' class='btn btn-danger btn-small'><i class='btn-icon-only icon-remove'> </i></a>
													</td>
												</tr>";
											}
										}
