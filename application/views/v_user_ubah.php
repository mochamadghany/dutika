				...
				<div class="span12">
					...
					<div class="widget widget-table action-table">
						...
						<div class="widget-content">
							<form action="<?= site_url('c_user/ubah_simpan') ?>" method="post">
								<?php foreach ($user as $ut): ?>
									...
									<table style="margin: 30px 140px 80px;">
										...
										<tr>
											<td>ID Hint</td>
											<td><input type="text" name="id_hint" value="<?= $ut->id_hint ?>" /></td>
										</tr>
										<tr>
											<td>Jawaban</td>
											<td><input type="text" name="jawaban" value="<?= $ut->jawaban ?>" /></td>
										</tr>
										<tr>
