...
<div class="content-versus">
  ...
  <!-- Side -->
        ...
        <p class="title-quiz-side">Quiz Populer</p>
        <br>
              <hr class="style2-quiz">
            <br>
      <?php foreach ($quizpopuler as $data) { ?>
        <div class="tile" style="background-image: url('<?php echo base_url();?>images/quiz/<?php echo $data->cover;?>');">
    ...
    steps.each(function(i){
      ...
      function submit(){
        var id = <?php echo $idquiznya;?> 
         $.ajax({
              type: "POST",
              url: "<?=base_url()?>user/bots/c_bots/quiz_ajax/"+id,
              data: $('form').serialize(),
