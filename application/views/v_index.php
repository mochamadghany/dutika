	...
	<div class="left">
		...
		<div class="find-match-warp">
			<center>
				...
				<p class="title-find" style="margin-top: 25px;">Lawan musuh mu!</p>
			</center>
		</div>
		<h2> MISI HARIAN </h2>
		<div class="hint-warp">
			<div class="columnsContainer-daily">
				...
				<div class="rightColumn-daily">
					<p>Misi harian : kalahkan 5 pemain</p>
					<p class="right-daily-how">Ayoo kalahkan 5 pemain dalam duel matematika dengan menjadi yang teratas di papan skor!</p>
					...
					<span class="value-daily">10</span>
					...
					<span class="value-daily">100</span>
