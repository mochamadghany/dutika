					...
					<div class="widget widget-table action-table">
						<div class="widget-header">
							...
							<div class="pull-right">
								<a href="<?= site_url('c_user/tambah') ?>" class="btn btn-small btn-primary">
								...
								<tbody>
									<?php $no=1; foreach ($user as $p): ?>
										<tr>
											...
											<td><?= $p->status ?></td>
											<td class="td-actions">
												<a href="<?= site_url('c_user/ubah').'/'.$p->id_user ?>" class="btn btn-small btn-success">
													<i class="btn-icon-only icon-edit"> </i>
												</a>
												<a href="<?= site_url('c_user/hapus').'/'.$p->id_user ?>" onclick="javascript: return confirm('Yakin ingin menghapus?')" class="btn btn-danger btn-small">
