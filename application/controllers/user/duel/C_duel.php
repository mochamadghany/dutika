...
class C_duel extends CI_Controller {
	...
	function hasil_find() {
		...
		if($cari_hasil[0]->hasil_status == 0) {
			...
			/* ID user untuk di panggil di function quiz_ajax() */
			$this->hary_id_pemain1 = $duel_id_user1;
			$this->hary_id_pemain2 = $duel_id_user2;
			?><script>alert(<?= $this->hary_id_user1 ?>+'\n'+<?= $this->hary_id_user2 ?>);</script><?php
			/* /ID user untuk di panggil di function quiz_ajax() */
		...
		<div class="col-md-3" style="margin-top:50px;">
			<div class="profile-card text-center">
				...
				<?php foreach ($data_duel as $soni):?>
					...
					<div>
						<img class="img-valign" src="<?php echo base_url();?>images/score.png" alt="" /><span class="non-data-text"><?php echo $soni->score_user;?> </span>
					</div>
					<br>
		...
		<div class="col-md-6">
			<div class="profile-card text-center" style="padding:5%;">
				...
				<div class="profile-info">
					...
					<div align="left">
						<ol class="hintfight">
							<li>You Must Answer 5 Question</li>
							<li>Each Question have 1 Correct and 3  Incorrect Answer</li>
							<li>If your Answer Correctly You will get +100 Score And +500 Coins</li>
							<li>If Opponent Answer Correct Before your Correct Answer you will get +50 Score  and +250 Coins</li>
							<li>If Your Answer Incorrectly You Will Get Score And if You Not Answer You Will Get 0 Score</li>
							<li>And Whoever get Highest Scores Win The Fight</li>
						</ol>
					</div>
				</div>
			</div>
	...
	function quiz_ajax() {
		...
		?><a href="<?= base_url() ?>"><button>KEMBALI KE MENU AWAL</button></a><?php

		// Menampilkan hasil duel dari saya dengan lawan
		$tampil_pemain1 = $this->m_duel->tampil_pemain($this->hary_id_pemain1); // bikin join antara tb_user dengan tb_user_level
		$tampil_pemain2 = $this->m_duel->tampil_pemain($this->hary_id_pemain2);

		foreach ($tampil_pemain1 as $tp1) {
			// Hasil duel saya
			echo "<div id='hasil'>";
				echo $tp1->nama . "<span>Level : " . $tp1->id_level . "</span>";
				echo "<hr />";
		...
		foreach ($tampil_pemain2 as $tp2) {
			// Hasil duel lawan
			echo "<div id='hasil'>";
				echo $tp2->nama . "<span>Level : " . $tp2->id_level . "</span>";
				echo "<hr />";
				echo " Jawaban Benar  : <span class='highlight'>" . $benar . "</span><br>";
				echo " Jawaban Salah  : <span class='highlight'>" . $salah . "</span><br>";
				echo " Tidak Terjawab  : <span class='highlight'>" . $takterjawab . "</span><br>";
